...
Original file is located at
    https://colab.research.google.com/drive/1-K3RA5XiYWxO1w-Wdji3A70YOGx97O-4
"""
...
# transfusion.names document helps you understand the dataset and how the variables affect our prediction column
#https://raw.githubusercontent.com/fatimaparada/Assignment2/master/transfusion.names
...
class NeuralNet:
    def __init__(self, dataFile, header=True, h=4):
        ...
        ncols = len(self.train_dataset.columns) #5
        nrows = len(self.train_dataset.index) #561
        ...
        self.Xt = self.test_dataset.iloc[:, 0:(ncolsT -1)].values.reshape(nrowsT, ncolsT-1)
        self.yt = self.test_dataset.iloc[:, (ncolsT-1)].values.reshape(nrowsT, 1)
    ...
    def train(self, max_iterations=10000, learning_rate=0.25):
        ...
        print("The final hidden weight vectors are (starting from input to output layers) \n" + str(self.W_hidden))
        print("The final weight vectors are (starting from input to output layers) \n" + str(self.W_output))

        print("The final hidden bias vectors are (starting from input to output layers) \n" + str(self.Wb_hidden))
    ...
    def forward_pass(self, activation='sigmoid'):
        ...
        #self.__activation(in_hidden, activation) 
        #-------------------------------------------------tanh
        # if activation == "tanh":
    ...
    def preprocessData(self, dataFile):
        ...
        X = imp_mean.fit_transform(dataFile)
        #changes array back into dataframe
        X = pd.DataFrame(dataFile, columns=dataFile.columns)
        return X

if __name__ == "__main__":
    # perform pre-processing of both training and test part of the test_dataset
    # split into train and test parts if needed
    neural_network = NeuralNet('https://raw.githubusercontent.com/fatimaparada/Assignment2/master/transfusion.data')
